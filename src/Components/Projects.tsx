		...
		<div className="mx-2 flex flex-col rounded-lg bg-white/20 backdrop-blur-lg md:mx-12 ">
			...
			<div className="flex flex-col items-center py-8">
				...
				<div className="flex flex-row">
					<button className="m-4 flex h-8 w-2/6 items-center justify-center rounded-md border-2 p-3 hover:bg-white hover:text-black md:w-48">
						<Link to={props.githubUrl}> Github Repo</Link>
					</button>
					<button className="m-4 flex h-8 w-2/6 items-center justify-center rounded-md border-2 p-3 hover:bg-white hover:text-black md:w-48">
						<Link to={props.liveDemo}>Live Demo</Link>
					</button>
				</div>
			</div>
		</div>
