			...
			<div className="flex flex-row">
				<div className="project grow pt-16 pl-24">
					...
					<p className="w-80">
						...
						felis. Phasellus nunc lectus, tincidunt eu enim ut, pretium tristique metus. Cras
						rhoncus justo mauris, vulputate commodo eros laoreet vitae...
					</p>
				...
				<div className="project grow pt-16 pl-24">
					<h2 className="pb-8 text-center text-5xl">Project Title 2</h2>
					<div
						className="projectImg bg-darkLiver h-80 w-80 items-center"
						alt="project screen shot"
					></div>
					<div className="languageContainer flex flex-row">
						<div className="language border-darkBlack bg-greyButton m-4 h-8 w-24 rounded-md border-2 text-center">
							REACT
						</div>
						<div className="language border-darkBlack bg-greyButton m-4 h-8 w-24 rounded-md border-2 text-center">
							HTML
				...
				<div className="project grow pt-16 pl-24">
					<h2 className="pb-8 text-center text-5xl">Project Title 3</h2>
					<div
						className="projectImg bg-darkLiver h-80 w-80 items-center"
						alt="project screen shot"
					></div>
